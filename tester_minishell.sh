...
run_tests "Builtins" builtins_tests builtins_expected
...
# mkdir -p test_path/dir1 test_path/dir2
# echo '#!/bin/sh' > test_path/dir1/hello
# echo 'echo Hello from dir1' >> test_path/dir1/hello
# chmod +x test_path/dir1/hello
# echo '#!/bin/sh' > test_path/dir2/hello
# echo 'echo Hello from dir2' >> test_path/dir2/hello
# chmod +x test_path/dir2/hello
# export PATH=$PWD/test_path/dir1:$PWD/test_path/dir2
# hello
...
# lsof -p <your_PID>
# strace -e openat,dup2,close ./minishell
# echo test > file.txt
