...
/*   Updated: 2025/09/03 15:43:58 by makhudon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static int handle_input_redirection(char **args, int i, t_process_data *process_data, t_execute_data *exec_data)
{
 ...
 * @return 0 on success, -1 on a file creation/access error.
 */
static int handle_output_truncation(char **args, int i, t_execute_data *exec_data)
{
 ...
 */
static int handle_heredoc_redirection(char **args, int i, t_process_data *process_data, t_execute_data *exec_data)
{
 ...
 * @param i The index of the redirection token.
 * @param process_data A pointer to the global process data.
 * @param exec_data A pointer to the t_execute_data struct containing redirection files.
